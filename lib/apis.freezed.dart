...
/// @nodoc
@JsonSerializable()
class _$GenerateContentRequestImpl implements _GenerateContentRequest {
  const _$GenerateContentRequestImpl({required final List<Content> contents})
      : _contents = contents;
  ...
  @override
  String toString() {
    return 'GenerateContentRequest(contents: $contents)';
  }
...
abstract class _GenerateContentRequest implements GenerateContentRequest {
  const factory _GenerateContentRequest(
      {required final List<Content> contents}) = _$GenerateContentRequestImpl;
